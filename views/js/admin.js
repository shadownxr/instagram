...
function handleEvents(version, notification) {
    var display_settings = document.querySelectorAll('input[name=' + version + '_display_style], input[name=' + version + '_show_title]');
