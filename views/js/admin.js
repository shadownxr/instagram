...
function backSliders() {
    var display_style = document.querySelector('input[name=' + Version.desktop + '_display_style]:checked');
    var m_display_style = document.querySelector('input[name=' + Version.mobile + '_display_style]:checked');
    if (display_style) {
...
var Slider = /** @class */ (function () {
    function Slider(version) {
        ...
        this.image_size_input = document.querySelector('input[name=' + this.version + '_image_size]');
        this.images_per_gallery = document.querySelector('input[name=' + this.version + '_images_per_gallery]');
        this.gap_input = document.querySelector('input[name=' + this.version + '_gap]');
        this.title_input = document.querySelector('input[name=' + this.version + '_title]');
        ...
        this.slider = new _splidejs_splide__WEBPACK_IMPORTED_MODULE_0__["default"]('#preview_' + this.version + '_slider', options);
        this.slider.mount();
        this.inputEvents();
    }
    Slider.prototype.inputEvents = function () {
        ...
        this.image_size_input.addEventListener("input", function () {
            ...
            var images = document.querySelectorAll('.' + _this.version + '_preview_images');
        ...
        this.title_input.addEventListener("input", function () {
            var title = document.querySelector(('#' + _this.version + '_settings') + ' .title h1');
...
function updateGrid(version) {
    var image_size_input = document.querySelector('input[name=' + version + '_image_size]');
    var gap_input = document.querySelector('input[name=' + version + '_gap]');
    var grid_row_input = document.querySelector('input[name=' + version + '_grid_row]');
    var grid_column_input = document.querySelector('input[name=' + version + '_grid_column]');
    var title_input = document.querySelector('input[name=' + version + '_title]');
    var grid_display = document.querySelector('.' + version + '_grid_display');
    ...
    image_size_input.addEventListener("input", function () {
        ...
        var images = document.querySelectorAll('.' + version + '_preview_images');
        images.forEach(function (image) {
            image.width = size;
            image.height = size;
        });
    ...
    title_input.addEventListener("input", function () {
        var title = document.querySelector(('#' + version + '_settings') + ' .title h1');
...
/* harmony import */ var _settings_tabs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./settings/tabs */ "./resources/js/settings/tabs.ts");
/* harmony import */ var _settings_notification__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./settings/notification */ "./resources/js/settings/notification.ts");




document.addEventListener("DOMContentLoaded", function () {
    (0,_settings_tabs__WEBPACK_IMPORTED_MODULE_2__.tabs)();
    (0,_settings_notification__WEBPACK_IMPORTED_MODULE_3__.notification)();
    (0,_slider__WEBPACK_IMPORTED_MODULE_1__.backSliders)();
});
