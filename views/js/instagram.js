...
function backSliders() {
    var display_style = document.querySelector('input[name="display_style"]');
    var m_display_style = document.querySelector('input[name=' + 'm_' + 'display_style]');
...
var Slider = /** @class */ (function () {
    function Slider(version) {
        ...
        this.image_size = document.querySelector('input[name=' + this.version + 'image_size]');
    ...
    Slider.prototype.inputEvents = function () {
        var _this = this;
        this.image_size.addEventListener("input", function () {
            _this.size = parseInt(_this.image_size.value);
...
function updateGrid(version) {
    var image_size = document.querySelector('input[name=' + version + 'image_size]');
