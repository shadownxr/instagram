...
$.when(fetchSettings()).done(function (response) {
    ...
    if (device['device']['type'] !== 'mobile') {
        new _splidejs_splide__WEBPACK_IMPORTED_MODULE_1__["default"]('#desktop_slider', {
            type: 'slide',
        ...
        var m_images_per_gallery_1 = 2;
        var m_gap_1 = 15;
        var m_image_size_1 = 150;
        new _splidejs_splide__WEBPACK_IMPORTED_MODULE_1__["default"]('.splide, #mobile_slider', {
            type: 'slide',
            perPage: m_images_per_gallery_1,
            perMove: 1,
            width: (m_images_per_gallery_1 * m_image_size_1) + Number(m_gap_1),
            gap: Number(m_gap_1),
        }).mount();
    }
    var m_images_per_gallery = 2;
    var m_gap = 15;
    var m_image_size = 150;
    new _splidejs_splide__WEBPACK_IMPORTED_MODULE_1__["default"]('#mobile_slider', {
        type: 'slide',
