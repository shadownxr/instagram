...
$.when(fetchSettings()).done(function (response) {
    ...
    if (device['type'] !== 'mobile' && device['type'] !== 'tablet') {
        ...
        var options = getOptions(response, MOBILE);
        new _splidejs_splide__WEBPACK_IMPORTED_MODULE_1__["default"]('#mobile_slider', options).mount();
    }
});
