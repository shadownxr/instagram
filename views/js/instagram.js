...
jQuery(function () {
    var image_size = $('input[name="image_size"]');
    var images_per_gallery = $('input[name="images_per_gallery"]');
    var gap_input = $('input[name="gap"]');
    var grid_display = $('.grid_display');
    var grid_row_input = $('input[name="grid_row"]');
    var grid_column_input = $('input[name="grid_column"]');
    var perPage = images_per_gallery.val();
    var size = image_size.val();
    var gap = gap_input.val();
    var grid_row = grid_row_input.val();
    var grid_column = grid_column_input.val();
    var m_image_size = $('input[name="m_image_size"]');
    var m_images_per_gallery = $('input[name="m_images_per_gallery"]');
    var m_gap_input = $('input[name="m_gap"]');
    var m_perPage = m_images_per_gallery.val();
    var m_size = m_image_size.val();
    var m_gap = m_gap_input.val();
    var m_grid_display = $('.m_grid_display');
    var m_grid_row_input = $('input[name="m_grid_row"]');
    var m_grid_column_input = $('input[name="m_grid_column"]');
    console.log(m_grid_row_input.length);
    var m_grid_row = m_grid_row_input.val();
    var m_grid_column = m_grid_column_input.val();
    var options = {
        type: 'slide',
        perPage: perPage,
        perMove: 1,
    ...
    if ($('#preview_desktop_slider').length) {
        ...
        images_per_gallery.on('input', function () {
            perPage = images_per_gallery.val();
            desktop_slider_1.options = {
                perPage: perPage,
                width: (perPage * size) + (Number(gap) * perPage) - gap,
            };
        });
        gap_input.on('input', function () {
            gap = gap_input.val();
            desktop_slider_1.options = {
                width: (perPage * size) + (Number(gap) * perPage) - gap,
                gap: Number(gap),
        ...
        grid_row_input.on('input', function () {
            grid_row = grid_row_input.val();
            grid_display.css('grid-template-rows', 'repeat(' + grid_row + ', 1fr)');
        });
        grid_column_input.on('input', function () {
            grid_column = grid_column_input.val();
    ...
    if ($('#preview_mobile_slider').length) {
        ...
        m_image_size.on('input', function () {
            m_size = m_image_size.val();
            $('.mobile_preview_images').width(m_size).height(m_size);
            mobile_slider_1.options = {
                width: (m_perPage * m_size) + (Number(m_gap) * m_perPage) - m_gap,
            };
        });
        m_images_per_gallery.on('input', function () {
            m_perPage = m_images_per_gallery.val();
            mobile_slider_1.options = {
                perPage: m_perPage,
                width: (m_perPage * m_size) + (Number(m_gap) * m_perPage) - m_gap,
            };
        });
        m_gap_input.on('input', function () {
            m_gap = m_gap_input.val();
            mobile_slider_1.options = {
                width: (m_perPage * m_size) + (Number(m_gap) * m_perPage) - m_gap,
                gap: Number(m_gap),
            };
        ...
        m_grid_row_input.on('input', function () {
            m_grid_row = m_grid_row_input.val();
            m_grid_display.css('grid-template-rows', 'repeat(' + m_grid_row + ', 1fr)');
        });
        m_grid_column_input.on('input', function () {
            m_grid_column = m_grid_column_input.val();
...
/******/ })()
;
//# sourceMappingURL=data:application/json;charset=utf-8;base64,