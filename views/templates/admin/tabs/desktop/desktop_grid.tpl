    ...
    <div class="panel">
        ...
        <div class="form-wrapper">
            ...
            >
                ...
                >
                <div class="prestashop-number-input-inputs">
                    <input class="form-control" type="number" value="{$settings->grid_row}" id="grid_row"
                           name="grid_row"/>
                </div>
            </div>
            ...
            >
                ...
                >
                <div class="prestashop-number-input-inputs">
                    <input class="form-control" type="number" value="{$settings->grid_column}" id="grid_column"
                           name="grid_column"/>
                </div>
            </div>
        </div>
