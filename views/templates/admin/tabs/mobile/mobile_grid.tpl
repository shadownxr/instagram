...
<form action="" method="POST">
    <div class="panel">
        ...
        <div class="form-group">
            ...
            <div
                    ...
                    data-label-nan="Not a number."
            >
                <label class="form-control-label" for="m_image_margin"
            ...
            <div
                    ...
                    data-label-nan="Not a number."
            >
                <label class="form-control-label" for="m_image_border_radius"
    ...
    <div class="panel">
        ...
        >
            ...
            >
            <div class="prestashop-number-input-inputs">
                <input class="form-control" type="number" value="{$settings->grid_row}" id="m_grid_row" name="m_grid_row"/>
            </div>
        </div>
        ...
        >
            ...
            >
            <div class="prestashop-number-input-inputs">
                <input class="form-control" type="number" value="{$settings->grid_column}" id="m_grid_column" name="m_grid_column"/>
            </div>
        </div>
