...
<div class="panel">
	...
	<p>
		{l s='You have to add valid ID and Secret of you Instagram App created in' mod='instagram'}  <a href="https://developers.facebook.com/">Meta for Developers</a> <br />
...
<div class="panel">
	...
	<p>
		{l s='Once you\'ve added basic configuration, press authorize to connect to your Instagram account and generate Access Token. After this step complete you will be able to access photos from your Instagram Account.' mod='instagram'} <br />
		<form action="https://api.instagram.com/oauth/authorize" method="GET" target="_blank">
			<input type="hidden" name="client_id" value={$instagram_app_id}></input>
...
<div class="panel">
	...
	<p>
		{l s='To make this module work correctly you have to add tokenrefresh and feedrefresh Cron jobs to you server. Check documentaion for additional information.' mod='instagram'} <br />
	</p>
</div>
